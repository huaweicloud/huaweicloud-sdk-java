...
/**
 * Model represent attributes of NodeGroupTemplate
 *
 * @author Ekasit Kijsipongse
 */
@JsonRootName("node_group_template")
public class MapReduceNodeGroupTemplate implements NodeGroupTemplate {
	...
	public static class NodeGroupTemplates extends ListResult<MapReduceNodeGroupTemplate> {

		private static final long serialVersionUID = 1L;

                @JsonProperty("node_group_templates")
		private List<MapReduceNodeGroupTemplate> nodeGroupTemplates;

		@Override
		protected List<MapReduceNodeGroupTemplate> value() {
	...
	public static class ConcreteNodeGroupTemplateBuilder implements NodeGroupTemplateBuilder {
		...
		private MapReduceNodeGroupTemplate m;

		ConcreteNodeGroupTemplateBuilder() {
			this(new MapReduceNodeGroupTemplate());
		}

		ConcreteNodeGroupTemplateBuilder(MapReduceNodeGroupTemplate m) {
			this.m = m;
		}
		...
		public NodeGroupTemplateBuilder from(NodeGroupTemplate in) {
			m = (MapReduceNodeGroupTemplate) in;
			return this;
                }
