...
package com.huawei.openstack4j.openstack.evs.v2.internal;
 ...
 public class JobService extends BaseElasticVolumeService{

      public JobService() {
         super(ServiceType.EVS, ReplaceVersionOfURL.instance("/v1"));
     }
      /**
      ...
      public Job get(String jobId){
          checkArgument(!((jobId==null)), "parameter `jobId` should not be empty");
