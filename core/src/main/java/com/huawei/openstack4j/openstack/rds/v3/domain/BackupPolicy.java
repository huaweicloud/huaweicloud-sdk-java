...
@NoArgsConstructor
@AllArgsConstructor
public class BackupPolicy implements ModelEntity{

	private static final long serialVersionUID = 6759071604149465937L;
	...
	/**
	 * Specifies the backup cycle configuration
	 */
