...
public class PeriodResourceService extends BaseBusinessSupportSystemService
{
    ...
    public QueryResourcesListRsp queryResourcesList(String domainID, Map<String, String> filteringParams)
    {
        ...
        Invocation<QueryResourcesListRsp>
    ...
    public AutoRenewRsp autoRenew(String domainID, String resourceId, Map<String, String> filteringParams)
    {
        ...
        Invocation<AutoRenewRsp> autoRenewInvocation = post(AutoRenewRsp.class, uri("/%s/common/order-mgr/resources/%s/actions", domainID, resourceId));
