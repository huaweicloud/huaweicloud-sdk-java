...
public interface IpsecPolicyService extends RestService {
	...
	NeutronIpsecPolicy create(NeutronIpsecPolicy model);
	
	List<NeutronIpsecPolicy> list(String field);
	
	NeutronIpsecPolicy	get(String policyId);
	
	ActionResponse	delete(String policyId);
	
	NeutronIpsecPolicy update(String policyId ,NeutronIpsecPolicy model );
}
