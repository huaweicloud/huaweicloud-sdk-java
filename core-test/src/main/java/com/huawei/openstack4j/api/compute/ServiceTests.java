...
import com.huawei.openstack4j.model.compute.ext.Service.State;
import com.huawei.openstack4j.model.compute.ext.Service.Status;
...
public class ServiceTests extends AbstractTest {
    ...
    /*public void serviceListingTest() throws Exception {
        ...
        List<? extends com.huawei.openstack4j.model.compute.ext.Service> services = osv3().compute().services().list();
        assertEquals(4, services.size());

        com.huawei.openstack4j.model.compute.ext.Service s = services.get(0);
