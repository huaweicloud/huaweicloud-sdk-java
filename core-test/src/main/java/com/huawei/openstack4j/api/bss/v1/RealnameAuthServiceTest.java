...
import com.huawei.openstack4j.openstack.bss.v1.domain.realnameAuth.*;
...
@Test(suiteName = "bss/v1/RealnameAuthService")
public class RealnameAuthServiceTest extends AbstractTest
{
    ...
    private static final String realname_individual_realname_auth= "/bss/realnameAuth/individualRealnameAuth.json";
    private static final String realname_enterprise_realname_auth= "/bss/realnameAuth/enterpriseRealnameAuth.json";
    private static final String realname_enterprise_realname_change_auth= "/bss/realnameAuth/enterpriseRealnameAuth.json";
    private static final String realname_auth_review_result= "/bss/realnameAuth/enterpriseRealnameAuth.json";
    ...
    public void individualRealnameAuthTest() throws Exception{
        ...
        RealnameAuthRsp rsp = osv3().bssV1().realnameAuthService().individualRealnameAuth(userDomainId, req);
    ...
    public void enterpriseRealnameAuthTest() throws Exception{
        ...
        RealnameAuthRsp rsp = osv3().bssV1().realnameAuthService().enterpriseRealnameAuth(userDomainId, req);
        RecordedRequest request = server.takeRequest();
    ...
    public void enterpriseRealnameAuthChangeTest() throws Exception{
        ...
        RealnameAuthRsp rsp = osv3().bssV1().realnameAuthService().enterpriseRealnameAuthChange(userDomainId, req);
        RecordedRequest request = server.takeRequest();
        assertEquals(request.getPath(),"/v1.0/userDomainId/partner/customer-mgr/realname-auth/enterprise");
    ...
    public void queryRealnameAuthReviewResultTest() throws Exception{
        ...
        QueryRealnameAuthReviewResultRsp
            rsp = osv3().bssV1().realnameAuthService().queryRealnameAuthReviewResult(userDomainId, filteringParams);
        RecordedRequest request = server.takeRequest();
