...
@Test(suiteName = "bssintl/v1/periodResourceService")
public class PeriodResourceServiceTest extends AbstractTest
{
    ...
    private static final String order_mgr_resources_detail= "/bssintl/periodResource/queryResourcesList.json";
    private static final String order_mgr_resources_renew= "/bssintl/periodResource/orderRenewByResourceId.json";
    private static final String order_mgr_resources_delete= "/bssintl/periodResource/orderDeleteByResourceId.json";
    private static final String order_mgr_resources_auto_renew= "/bssintl/periodResource/autoRenew.json";
    private static final String order_mgr_resources_cancel_auto_renew= "/bssintl/periodResource/cancelAutoRenew.json";
    ...
    public void queryResourcesListTest() throws Exception{
        ...
        QueryResourcesListRsp rsp = osv3().bssintlV1()
    ...
    public void orderRenewByResourceIdTest() throws Exception{
        ...
        OrderRenewByResourceIdReq
            ...
            .expireMode(3)
            .build();
        OrderRenewByResourceIdRsp
            rsp = osv3().bssintlV1().periodResourceService().orderRenewByResourceId(userDomainId, req);
    ...
    public void orderDeleteByResourceIdTest() throws Exception{
        ...
        OrderDeleteByResourceIdRsp rsp =
            osv3().bssintlV1().periodResourceService().orderDeleteByResourceId(userDomainId, req);
    ...
    public void autoRenewTest() throws Exception{
        ...
        AutoRenewRsp
            rsp = osv3().bssintlV1().periodResourceService().autoRenew(userDomainId, resourceId, filteringParams);
    ...
    public void cancelAutoRenewTest() throws Exception{
        ...
        CancelAutoRenewRsp rsp =
            osv3().bssintlV1().periodResourceService().cancelAutoRenew(userDomainId, resourceId, filteringParams);
