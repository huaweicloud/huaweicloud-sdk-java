...
@Test(suiteName = "bssintl/v1/BillService")
public class BillServiceTest extends AbstractTest
{
    ...
    private static final String account_mgr_postpaid_bill_summary= "/bssintl/bill/queryPostpaidBill.json";
    private static final String account_mgr_bill_monthly_sum= "/bssintl/bill/queryMonthlySum.json";
    private static final String account_mgr_bill_res_records= "/bssintl/bill/queryResRecord.json";
    private static final String account_mgr_bill_res_fee_records= "/bssintl/bill/queryResFeeRecord.json";


    @Test
    public void queryPostpaidBillTest() throws Exception{
        respondWith(account_mgr_postpaid_bill_summary);
        ...
        QueryPostpaidBillRsp rsp = osv3().bssintlV1().billService().queryPostpaidBill(userDomainId, filteringParams);
        RecordedRequest request = server.takeRequest();
        assertEquals(request.getPath(),"/v1.0/userDomainId/partner/account-mgr/postpaid-bill-summary?consume_month=2019-09");
    ...
    public void queryMonthlySumTest() throws Exception{
        ...
        QueryMonthlySumRsp rsp = osv3().bssintlV1().billService().queryMonthlySum(userDomainId, filteringParams);
    ...
    public void queryResRecordTest() throws Exception{
        ...
        QueryResRecordRsp rsp = osv3().bssintlV1() .billService()
    ...
    public void queryResFeeRecordTest() throws Exception{
        ...
        QueryResFeeRecordRsp rsp = osv3().bssintlV1().billService().queryResFeeRecord(userDomainId, filteringParams);
        RecordedRequest request = server.takeRequest();
