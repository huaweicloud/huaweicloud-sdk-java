...
@Test(suiteName = "bss/v1/PeriodOrderService")
public class PeriodOrderServiceTest extends AbstractTest
{
    ...
    private static final String order_mgr_orders_List= "/bss/periodOrder/queryOrdersList.json";
    private static final String order_mgr_orders_detail= "/bss/periodOrder/queryOrdersDetail.json";
    private static final String order_mgr__order_pay= "/bss/periodOrder/orderPay.json";
    private static final String order_mgr__order_unsubscribe= "/bss/periodOrder/unsubscribeOrder.json";
    private static final String order_mgr__order_cancel= "/bss/periodOrder/orderActions.json";
    private static final String order_mgr__order_refund_order= "/bss/periodOrder/queryRefundOrder.json";
    private static final String order_mgr__order_refund_resource= "/bss/periodOrder/queryRefundOrder.json";
    ...
    public void queryOrdersListTest() throws Exception{
        ...
        QueryOrdersListRsp rsp =
            osv3().bssV1().periodOrderService().queryOrdersList(userDomainId, filteringParams);
    ...
    public void queryOrderDetailTest() throws Exception{
        ...
        QueryOrderDetailRsp rsp =
            osv3().bssV1().periodOrderService().queryOrderDetail(userDomainId, orderId, filteringParams);
        RecordedRequest request = server.takeRequest();
    ...
    public void orderPayTest() throws Exception{
        ...
        OrderPayReq req = OrderPayReq.builder().orderId("CS1910091944Y0CQ1")
            .build();
        OrderPayRsp rsp = osv3().bssV1().periodOrderService().orderPay(userDomainId, req);
    ...
    public void unsubscribeOrderTest() throws Exception{
        ...
        UnsubscribeOrderRsp rsp =
            osv3().bssV1().periodOrderService().unsubscribeOrder(userDomainId, orderId, filteringParams);
        RecordedRequest request = server.takeRequest();
    ...
    public void orderActionsTest() throws Exception{
        ...
        OrderActionsRsp rsp = osv3().bssV1().periodOrderService().orderActions(userDomainId, filteringParams, req);
        RecordedRequest request = server.takeRequest();
    ...
    public void queryRefundOrderTest() throws Exception{
        ...
        QueryRefundOrderRsp rsp = osv3().bssV1().periodOrderService().queryRefundOrder(userDomainId, filteringParams);
        RecordedRequest request = server.takeRequest();
    ...
    public void queryResourcesTest() throws Exception{
        ...
        filteringParams.put("limit", "10");
        QueryResourcesRsp
            rsp = osv3().bssV1().periodOrderService().queryResources(userDomainId, orderId, filteringParams);
        RecordedRequest request = server.takeRequest();
