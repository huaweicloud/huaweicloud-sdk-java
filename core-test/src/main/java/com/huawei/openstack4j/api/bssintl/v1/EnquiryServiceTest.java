...
import com.huawei.openstack4j.openstack.bssintl.v1.domain.enquiry.ProductInfoForQueryRating;
...
@Test(suiteName = "bssintl/v1/EnquiryService")
public class EnquiryServiceTest extends AbstractTest
{
    ...
    private static final String product_mgr_query_rating= "/bssintl/enquiry/queryRating.json";
    ...
    public void queryRatingTest() throws Exception{
        ...
        QueryRatingReq req = QueryRatingReq.builder()
            ...
            .build();
        QueryRatingRsp rsp = osv3().bssintlV1().enquiryService().queryRating(userDomainId, req);
