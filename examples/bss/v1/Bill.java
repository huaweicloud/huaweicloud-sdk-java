...
public class Bill
{
    ...
    {
        try {
            QueryMonthlySumRsp rsp = client.bssV1().billService().queryMonthlySum(domainID, filteringParams);
            return rsp;
        }
    ...
    {
        try {
            QueryResRecordRsp rsp = client.bssV1().billService().queryResRecord(domainID, filteringParams);
            return rsp;
        }
        catch (ClientResponseException e1)
        {
    ...
    {
        try {
            QueryResFeeRecordRsp rsp = client.bssV1().billService().queryResFeeRecord(domainID, filteringParams);
            return rsp;
        }
        catch (ClientResponseException e1)
        {
