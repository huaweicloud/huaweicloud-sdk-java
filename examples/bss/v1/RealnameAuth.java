...
public class RealnameAuth
{
    ...
    {
        try {
            RealnameAuthRsp rsp = client.bssV1().realnameAuthService().individualRealnameAuth(domainID, req);
            return rsp;
        }
    ...
    {
        try {
            RealnameAuthRsp rsp = client.bssV1().realnameAuthService().enterpriseRealnameAuth(domainID, req);
            return rsp;
        }
        catch (ClientResponseException e1)
        {
    ...
    {
        try {
            RealnameAuthRsp rsp = client.bssV1().realnameAuthService().enterpriseRealnameAuthChange(domainID, req);
            return rsp;
        }
        catch (ClientResponseException e1)
        {
    ...
    {
        try {
            QueryRealnameAuthReviewResultRsp rsp = client.bssV1().realnameAuthService().queryRealnameAuthReviewResult(domainID, filteringParams);
            return rsp;
        }
        catch (ClientResponseException e1)
        {
