...
public class Utilities
{
    ...
    {
        try {
            SendVerificationCodeRsp rsp = client.bssintlV1().utilitiesService().sendVerificationCode(domainID, req);
            return rsp;
        }
...
//Sending a Verification Code
        SendVerificationCodeReq req =
            SendVerificationCodeReq.builder().receiverType(2).email("xxx@xxx.com").build();
