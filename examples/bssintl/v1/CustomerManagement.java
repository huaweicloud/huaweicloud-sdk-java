...
public class CustomerManagement
{
    ...
    {
        try {
            CheckUserRsp rsp = client.bssintlV1().customerManagementService().checkUser(domainID, req);
            return rsp;
        }
    ...
    {
        try {
            CreateCustomerRsp rsp = client.bssintlV1().customerManagementService().createCustomer(domainID, req);
            return rsp;
        }
        catch (ClientResponseException e1)
        {
    ...
    {
        try {
            QueryCustomerInfoListRsp rsp = client.bssintlV1().customerManagementService().queryCustomerInfoList(domainID, req);
            return rsp;
        }
        catch (ClientResponseException e1)
        {
    ...
    private static SetCustomersFrozenRsp setCustomersFrozen(OSClient.OSClientV3 client, String domainID, SetCustomersFrozenReq req)
    {
        try {
            SetCustomersFrozenRsp rsp = client.bssintlV1().customerManagementService().setCustomersFrozen(domainID, req);
            return rsp;
        }
        catch (ClientResponseException e1)
        {
    ...
    private static SetCustomersFrozenRsp setCustomersUnfrozen(OSClient.OSClientV3 client, String domainID, SetCustomersFrozenReq req)
    {
        try {
            SetCustomersFrozenRsp rsp = client.bssintlV1().customerManagementService().setCustomersUnfrozen(domainID, req);
            return rsp;
        }
        catch (ClientResponseException e1)
        {
...
//Querying Customers
        QueryCustomerInfoListReq queryCustomerInfoListReq = QueryCustomerInfoListReq.builder()
            ...
            .build();
        QueryCustomerInfoListRsp queryCustomerInfoListRsp = queryCustomerInfoList(osclient, domainId, queryCustomerInfoListReq);

//Freezing a Customer Account
        List<String> customerIdsFrozen = new ArrayList<>();
        customerIdsFrozen.add("xxx1");
        customerIdsFrozen.add("xxx2");
        SetCustomersFrozenReq req = SetCustomersFrozenReq.builder()
            .customerIds(customerIdsFrozen)
            .reason("testqianfei")
            .build();
        SetCustomersFrozenRsp rsp = setCustomersFrozen(osclient, domainId, req);

//Unfreezing a Customer Account
        List<String> customerIdsUnfrozen = new ArrayList<>();
        customerIdsUnfrozen.add("xxx1");
        customerIdsUnfrozen.add("xxx2");
        SetCustomersFrozenReq setCustomersFrozenReq = SetCustomersFrozenReq.builder()
            .customerIds(customerIdsUnfrozen)
            .reason("testqianfei")
            .build();
        SetCustomersFrozenRsp setCustomersFrozenRsp = setCustomersUnfrozen(osclient, domainId, setCustomersFrozenReq);
    }
}
