...
public class PeriodResource
{
    ...
    {
        try {
            QueryResourcesListRsp rsp = client.bssintlV1().periodResourceService().queryResourcesList(domainID, filteringParams);
            return rsp;
        }
    ...
    {
        try {
            OrderRenewByResourceIdRsp rsp = client.bssintlV1().periodResourceService().orderRenewByResourceId(domainID, req);
            return rsp;
        }
        catch (ClientResponseException e1)
        {
    ...
    {
        try {
            OrderDeleteByResourceIdRsp rsp = client.bssintlV1().periodResourceService().orderDeleteByResourceId(domainID, req);
            return rsp;
        }
        catch (ClientResponseException e1)
        {
        ...
        Map<String, String> filteringParams)
    {
        ...
        {
            AutoRenewRsp rsp =
                client.bssintlV1().periodResourceService().autoRenew(domainID, resourceId, filteringParams);
            return rsp;
        }
        catch (ClientResponseException e1)
        {
    ...
    {
        try {
            CancelAutoRenewRsp rsp = client.bssintlV1().periodResourceService().cancelAutoRenew(domainID, resourceId, filteringParams);
            return rsp;
        }
        catch (ClientResponseException e1)
        {
