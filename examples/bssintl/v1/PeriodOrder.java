...
public class PeriodOrder
{
    ...
    {
        try {
            QueryOrdersListRsp rsp = client.bssintlV1().periodOrderService().queryOrdersList(domainID, filteringParams);
            return rsp;
        }
    ...
    {
        try {
            QueryOrderDetailRsp rsp = client.bssintlV1().periodOrderService().queryOrderDetail(domainID, orderId, filteringParams);
            return rsp;
        }
        catch (ClientResponseException e1)
        {
    ...
    {
        try {
            OrderPayRsp rsp = client.bssintlV1().periodOrderService().orderPay(domainID, req);
            return rsp;
        }
        catch (ClientResponseException e1)
        {
    ...
    {
        try {
            UnsubscribeOrderRsp rsp = client.bssintlV1().periodOrderService().unsubscribeOrder(domainID, orderId, filteringParams);
            return rsp;
        }
        catch (ClientResponseException e1)
        {
    ...
    {
        try {
            OrderActionsRsp rsp = client.bssintlV1().periodOrderService().orderActions(domainID, filteringParams, req);
            return rsp;
        }
        catch (ClientResponseException e1)
        {
    ...
    {
        try {
            QueryRefundOrderRsp rsp = client.bssintlV1().periodOrderService().queryRefundOrder(domainID, filteringParams);
            return rsp;
        }
        catch (ClientResponseException e1)
        {
    ...
    {
        try {
            QueryResourcesRsp rsp = client.bssintlV1().periodOrderService().queryResources(domainID, orderId, filteringParams);
            return rsp;
        }
        catch (ClientResponseException e1)
        {
